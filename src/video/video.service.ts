...
//     backAudioDir:path.join(assetsDir,'back-audio'),
...
//     musicDir: path.join(process.cwd(), 'assets', 'music'),
//     globalAudioDir: path.join(process.cwd(), 'assets', 'audio'),
//   };

//   // Create all dynamic directories (ignore global static)
//   console.log(`\n📁 Creating directories for request: ${requestId}`);
//   for (const [key, dir] of Object.entries(dirs)) {
//     if (key === 'musicDir' || key === 'globalAudioDir') continue; // don't create global
...
export class VideoService {
  ...
  private maxActiveRequests = 10; // Maximum concurrent requests to keep
